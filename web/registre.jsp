    	...
    	<div class="col-md-4 col-md-offset-4">
    		<div class="panel panel-default">
			  	...
			  	<div class="panel-body">
			    	<form accept-charset="UTF-8" role="form" action="RegistreServlet" method="post">
                    <fieldset>
			    	  	...
			    	  	<div class="form-group">
			    		    <input id="email" class="form-control" placeholder="yourmail@example.com" name="email" type="email">
			    		</div>
			    		<div class="form-group">
                    ...
                    <a href="login.jsp" class="btn btn-lg btn-facebook btn-block">Login</a>
			    </div>
			</div>
		</div>
	</div>
